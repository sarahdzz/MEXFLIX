...
{
    //EN VEZ DE CREAR SERA SET Y REPLACE ES LA FUNCION CREAR Y UPDATE
    //YA QUE TIENEN LOS MISMOS PARAMETROS 
    ...
    //cambiamos a get por que es una clase hija de model
    ...
    //cambiamos a del por que es una clase hija de model
